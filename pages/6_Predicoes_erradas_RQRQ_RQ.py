...
st.write('#### O modelo cometeu um erro ao classificar como RQRQ_RQ, porém o real é que são RQ_RQ')
...
# gerar o gráfico
fig = go.Figure()
for espectro in tqdm(range(len(espectros['RQRQ_RQ']))):
    fig.add_trace(go.Scatter(
        x = espectros['RQRQ_RQ'][espectro][181:362],
        y = espectros['RQRQ_RQ'][espectro][362:],
        mode='markers',
        marker_size=10,
        opacity=1.0,
        marker=dict(
